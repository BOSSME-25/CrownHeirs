...
export default function MobileNav({ isAdmin, canManage, canManageTeam, email, unread = 0 }: { isAdmin?: boolean; canManage?: boolean; canManageTeam?: boolean; email?: string | null; unread?: number }) {
